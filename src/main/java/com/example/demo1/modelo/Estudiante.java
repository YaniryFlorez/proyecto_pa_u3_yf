...
@Entity
@Table(name ="estudiante")//relacion tabla objeto java
@NamedQuery(name="Estudiante.buscarPorApe", query ="select e from Estudiante e where e.nombre = :datoNombre")
@NamedNativeQuery(name="Estudiante.buscarPorNombre", query ="select e from Estudiante e where e.nombre = :datoNombre")
